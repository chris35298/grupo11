...
class RelojClass:
    def __init__(self):
        ...
        self.etiqueta_localizacion = Label(self.ventana, text="Hora Local", width=25, font=("Lucida Sans", 23, "bold"), bg="white", fg="black")
        # Colocar la etiqueta en la ventana
        self.etiqueta_localizacion.place(x=0, y=20)
        
        # Crear un combobox para seleccionar la ciudad
        self.entrada = ttk.Combobox(self.ventana, width=26)
        ...
        self.entrada["values"] = ["Hora Local","Argentina","Brasil","Chile","México","Paraguay","Perú","Uruguay","Venezuela","Canadá","Estados Unidos",
                                  "Alemania","España","Francia","Italia","Países Bajos","Reino Unido","Qatar","China", "Japón", "Rusia",
        ...
        self.entrada.config(font=("Lucida Sans", 13, "bold"))
    ...
    def mostrar_hora(self):
        ...
        self.reloj.config(text=hora_actual,bg="white", fg="black", font=("Colonna MT", 76, "bold"))
        # Llamar al método mostrar_hora nuevamente después de 200 milisegundos
        self.reloj.after(1000, self.mostrar_hora)
